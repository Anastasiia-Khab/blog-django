...
window.addEventListener("load", function() {
  ...
  function Color(h,s,l) {
	...
	var colorPoints = [
		new ColorPoint(0, 0, new Color(187, 27, 49)),
		new ColorPoint(0, 1, new Color(294, 49, 27)),
		new ColorPoint(1, 0, new Color(187, 27, 49)),
		new ColorPoint(1, 1, new Color(294, 49, 27))
	];
